...
def test_driver_in_e2b(
    ...
    try:
        ...
        # Note: E2B SDK v1.0.4+ uses Sandbox() constructor, not Sandbox.create()
        # API key is read from E2B_API_KEY environment variable automatically
        sandbox = Sandbox(timeout=120)  # 2 minutes for driver tests
