...
REST driver for Open-Meteo following Driver Design v2.0 spec.
...
class OpenMeteoDriver:
    ...
    def __init__(
        ...
        **kwargs
        ...
        Args:
            api_url: Base URL for API (https://api.open-meteo.com/v1)
    ...
    def list_objects(self) -> List[str]:
        ...
        try:
            ...
            # Open-Meteo API has these known objects/endpoints:
            return [{'name': 'forecast', 'path': '/forecast', 'method': 'GET', 'description': 'Weather forecast data with current, hourly, and daily forecasts', 'required_params': ['latitude', 'longitude'], 'optional_params': ['hourly', 'daily', 'current_weather', 'temperature_unit', 'windspeed_unit', 'precipitation_unit', 'timezone', 'start_date', 'end_date']}]
            ...
            if e.response.status_code == 404:
                raise ConnectionError(
                    "Open-Meteo API schema endpoint not found. This API may not support automatic discovery.",
