"""
Open-Meteo Driver - Unit Tests

Unit tests for open_meteo_driver with mocked API responses.
...
class TestDriverInitialization:
    ...
    def test_from_env_missing_url(self):
        ...
        with pytest.raises(AuthenticationError) as exc_info:
            OpenMeteoDriver.from_env()

        assert "OPEN_METEO_DRIVER_API_URL" in str(exc_info.value)
